...
const PosFilter = ({ setFilteredProducts }) => {
  ...
  useEffect(() => {
    fetch(`https://backend-api-mbln.onrender.com/api/v1/product/filter?category=Pos`)
  ...
  const applyFilters = updatedFilters => {
    ...
    fetch(`https://backend-api-mbln.onrender.com/api/v1/product/filter?category=Pos&${queryString}`)
      .then(response => response.json())
      .then(data => {
        setFilteredProducts(data.data)
      })
