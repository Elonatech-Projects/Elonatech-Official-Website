...
const SingleProduct = () => {
  ...
  const fetchAllProductsInCategory = () => {
    fetch(`https://backend-api-mbln.onrender.com/api/v1/product/filter?category=${category}`)
  ...
  const fetchRecentlyViewedProducts = async () => {
    try {
      const res = await axios.get(
        `https://backend-api-mbln.onrender.com/api/v1/product/products/recently-viewed`
      )
  ...
  const fetchRelatedProducts = async () => {
    try {
      const res = await axios.get(`https://backend-api-mbln.onrender.com/api/v1/product/${id}/related`)
