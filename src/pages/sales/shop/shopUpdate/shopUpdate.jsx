...
const ShopUpdate = () => {
  ...
  const handleSubmit = async (e) => {
    try {
      ...
      await axios.put(`https://backend-api-mbln.onrender.com/api/v1/product/${id}/update`, newData);
  ...
  const handleSubmitImage = async (e) => {
    try {
      ...
      await axios.put(`https://backend-api-mbln.onrender.com/api/v1/product/${id}/update/image`, newData);
